...
const steps = [
  {
    ...
    subtitle: "Verstehen",
    body:
      "30 Minuten am Telefon oder per Video. Wir sprechen über Ihre Praxis, aktuelle Abrechnungssoftware, Ihr Volumen und offene Baustellen. Danach wissen Sie, was ich für Sie tun kann und ob ich passe.",
    time: "≈ 30 Min",
  ...
  },
  {
    ...
    subtitle: "Beziffern",
    body:
      "Ich sichte anonymisierte Beispielrechnungen und Ihren aktuellen Prozess. Sie erhalten ein transparentes Angebot mit Umfang, Preis und Startdatum. Kein Kleingedrucktes, keine Sammelposten.",
    time: "3-5 Werktage",
  ...
  },
  {
    ...
    subtitle: "Einrichten",
    body:
      "Zugänge, DSGVO-Vereinbarung, Softwareschnittstellen. Ich richte alles ein, teste an Musterdaten und stimme mich mit Ihrem Team ab. Der Praxisalltag läuft parallel unverändert weiter.",
    time: "1-2 Wochen",
  ...
  },
  {
    ...
    subtitle: "Führen",
    body:
      "Feste Abrechnungstage pro Woche, klare Ansprechzeiten, monatliches Kurzreporting. Sie sehen jederzeit Umsatz, offene Punkte und was in Bearbeitung ist. Diskret, verlässlich, planbar.",
    time: "Ab sofort",
    detail: ["Feste Turnusse", "Monats-Report", "Direktleitung"],
  },
];
...
export default function Process() {
  ...
  return (
    <section id="ablauf" ref={ref} className="relative overflow-hidden py-32 sm:py-40">
      <motion.div
        style={{ x: numberX }}
        aria-hidden
        className="pointer-events-none absolute -top-4 -right-8 select-none font-display italic text-[26vw] leading-[0.85] tracking-tight text-navy/[0.04] whitespace-nowrap"
      >
        Ablauf
      </motion.div>
      ...
      <div className="relative mx-auto max-w-[1500px] px-6 sm:px-10">
          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            <div className="max-w-sm">
              <p className="text-[14px] leading-[1.7] text-navy/70">
                Vom ersten Kontakt bis zur laufenden Betreuung. Sie wissen
                immer, wo wir stehen und was als Nächstes passiert.
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <div className="relative mt-24 grid grid-cols-1 gap-24">
          {/* Progressbar-Rail links */}
          <div className="pointer-events-none absolute left-4 top-0 h-full w-px bg-line/60 sm:left-[calc(30%-1px)]" />
          <motion.div
    ...
    <Reveal>
      <div className="relative grid grid-cols-1 gap-8 sm:grid-cols-[30%_1fr]">
        ...
        <div className="relative pl-12 sm:pl-0">
          <div className="absolute top-4 -left-2 sm:left-auto sm:right-0 sm:translate-x-1/2 h-4 w-4 rounded-full border border-petrol bg-ivory z-[1]">
